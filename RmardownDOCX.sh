...
#pandoc --to docx --from markdown --filter pandoc-citeproc -s -o CP-EMS-PS-Kap-6-Soziologinnen.docx Kap-6_Soziologinnen.rmd
pandoc --to docx --from markdown --filter pandoc-citeproc -s -o CP-EMS-PS-Kap-7-Transformers.docx Kap-7-Transformers.rmd
